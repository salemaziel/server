...
[Linux is not a secure operating system](../linux.html). However, there are steps you can take to improve it. This guide aims to explain how to harden Linux as much as possible for security and privacy. This guide attempts to be distribution-agnostic and is not tied to any specific one.  
...
[1\. Choosing the right Linux distribution](#choosing-the-right-distro) [2\. Kernel hardening](#kernel) [2.1 Stable vs. LTS](#stable-vs-lts)  
...
The best distribution to use as a base for your hardened operating system would be [Gentoo Linux](https://www.gentoo.org/), as it allows you to configure your system exactly how you want it to be, which will be extremely useful, especially when we come to [more secure compilation flags](#hardened-compilation-flags) later in the guide.  
