...
#		PING6="ping6 -c3 ipv6.google.com > /dev/null 2>&1"
		PING6="ping6 -c3 ipv6.icanhazip.com > /dev/null 2>&1"
	else
#		PING6="ping -6 -c3 ipv6.google.com > /dev/null 2>&1"
		PING6="ping -6 -c3 ipv6.icanhazip.com > /dev/null 2>&1"
	fi
	if eval "$PING6"; then
	...
	echo "   2) Self-hosted DNS Resolver (Unbound) (recommended)"
	echo "   3) Cloudflare (Anycast: worldwide)"
	echo "   4) Quad9 (Anycast: worldwide) (recommended)"
	echo "   5) Quad9 uncensored (Anycast: worldwide) (recommended)"
	echo "   6) FDN (France)"
	...
	echo "   12) NextDNS (Anycast: worldwide) (recommended)"
	echo "   13) Custom"
...
function installOpenVPN() {
	if [[ $AUTO_INSTALL == "y" ]]; then
		...
		if [[ $IPV6_SUPPORT == "y" ]]; then
			...
			PUBLIC_IP=$(curl -4 https://ipv4.icanhazip.com)
		fi
